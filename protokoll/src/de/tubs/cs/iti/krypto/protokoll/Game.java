...
public class Game {
	...
	/**
	 * Fuegt den ServerThread eines neuen Mitspielers zur bestehenden
	 * Spielerliste hinzu und erhoeht die Spieleranzahl ("currentPlayers") um 1.
	 ...
	 * Spielern eines Spiels, wenn das Spiel bereits gestartet ist. Ist das
	 * Spiel ncoh nicht gestartet, so wird nur der Spieler, der den Fehler
	 * gemeldet hat aus dem Spiel entfernt.
	 * 
	 * @param errorPlayer
	...
	/**
	 * Sendet an alle Spieler die Nachricht, dass das Spiel gestartet werden
	 * kann. Diese Methode wird vom ServerThread des ersten Spielers aufgerufen,
	 * nachdem dieser den "Spiel starten"-Button betaetigt hat (siehe auch
	 * Diagramm "Spiel starten").
	 */
	public void start() {
